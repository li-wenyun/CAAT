...
def get_args_parser():
    ...
    parser.add_argument('--block', type=str, default='BlockCAATParallel')
    ...
    if args.resume:
        ...
        if '.pth' in args.resume:
            ...
            if args.resume.endswith('mae_pretrain_vit_base.pth'):
                # print(torch.load(args.resume, map_location='cpu'))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('CAAT training and evaluation script', parents=[get_args_parser()])
